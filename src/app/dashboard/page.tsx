      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          <div className="text-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{stats.totalCircles}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{stats.totalSaved}</p>
                ...
                <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-900">Emergency Fund</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-slate-900">0.35 / 0.5 BTC</span>
                    </div>
                ...
                <div className="p-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-900">Vacation Savings</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-600">Progress</span>
                      <span className="font-medium text-slate-900">0.12 / 0.2 BTC</span>
                    </div>
                ...
                <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-100">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-900">Investment Fund</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-600">Progress</span>
                      <span className="font-medium text-slate-900">0.8 / 1.0 BTC</span>
                    </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Completed your first savings circle</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Reached 3 savings goals</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Joined 5 different circles</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm font-medium text-slate-900">0.12 / 0.15 BTC</span>
                  </div>
                  <Progress value={80} className="h-2" />
                </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm text-slate-600">Circle Participation</span>
                    <span className="text-sm font-medium text-slate-900">18 / 20 days</span>
                  </div>
                ...
                <div className="pt-2 border-t border-slate-100">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-1">
                      <span className="text-lg font-bold text-green-600">4.25</span>
