            ...
            <CardContent className='grid lg:grid-cols-2 gap-8 items-center p-0'>
              <div>
                ...
                <p className='text-gray-300 mb-6'>
                  ...
                  targets, define contribution schedules, and watch your Bitcoin
                  grove flourish. Every tree represents a shared financial
                  milestone.
                </p>
                <Link href='/create'>
                  <Button
            ...
            <CardContent className='grid lg:grid-cols-2 gap-8 items-center p-0'>
              ...
              <div>
                ...
                <p className='text-gray-300 mb-6'>
                  ...
                  messages. Climb the generosity leaderboards and earn exclusive
                  SBTs for top gifters.
                </p>
                <Button
                  variant='outline'
